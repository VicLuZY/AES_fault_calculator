...
pub fn sample_network() -> Network {
    ...
    n.project = ProjectInfo {
        ...
        description: "Single infinite utility starter model for the browser SLD workstation.".to_string(),
    };
    n.add_bus("util_bus", "Utility bus", 0.6, 360.0, 320.0).unwrap();
    n.add_source(Source {
        ...
        notes: "Replace with project-specific utility source impedance before issued work.".to_string(),
    }).unwrap();
    n.notes.push("Starter case for a simple single-line diagram.".to_string());
    n
}
